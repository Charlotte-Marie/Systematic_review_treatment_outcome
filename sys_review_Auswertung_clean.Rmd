...
## Plot reported and balanced accuracy without (1) and with risk of bias (2)
```{r RQ 1: Accuracy of treatment outcome prediction}

# Add column for ROB/risk of data leakage to data_acc using information from 4.8. in data_PROBAST
...
# Output and safe both plots with sensible defaults
...
# Output and safe plots with sensible defaults
...
```{r RQ 2.1: Approaches used for calculation of feature importance}
...
```{r RQ 2.2: Which features have predictive value?}
